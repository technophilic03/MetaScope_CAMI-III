...
#
# The profiling call is Basic Protocol 1 of Ruscheweyh et al. 2021, Current
# Protocols 1:e218 (doi:10.1002/cpz1.218), and -C is Support Protocol 3:
#
...
# across the taxids. parenthesis keeps them, writing the TAXID field as
# "(1328/1338)". print_CAMI.py calls that "not tecnically in CAMI format", so
# OPAL cannot pair those rows. Write parenthesis to read, not to score.
